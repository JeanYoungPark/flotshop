...
export const AdminRegister = () => {
    ...
    }, [email, id, name, navigate, password, userId])
        ...
        <div className='pt-10 flex w-full h-full justify-center items-center'>
            <form className='space-y-6 min-w-1/2' onSubmit={onSubmit}>
                ...
                <div>
                    ...
                    <div className="mt-2">
                        <input id="password" type="password" value={password} onChange={(e) => setPassword(e.target.value)} required maxLength={15} className="block w-full rounded-md border-0 py-1.5 pl-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 outline-0" />
                    </div>
                </div>
                <div>
