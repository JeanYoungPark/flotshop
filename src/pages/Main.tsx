                        ...
                        <ReactFullpage.Wrapper>
                            ...
                            <div className="section footer">
                                <div>
                                    <div>
                                        <h3>고객센터</h3>
                                        <div>070-7699-1292<span>am 10:00 ~ pm 5:00</span></div>
                                        <div>우리은행 1005-203-044995 박진욱(플로트)</div>
                                    </div>
                                    <ul>
                                        <li>페이스북</li>
                                        <li>인스타그램</li>
                                ...
                                <div>
                                    ...
                                    <p className="copyright">Copyright © <strong>FLOTSHOP:플로트</strong>. All rights reserved.</p>
                                    <p>
