    ...
    useEffect(() => {
        const markerList : MarkerList = {
            'red': [
                ...
                { lat: 37.554961, lng: 126.970142, type: '롯데마트', title: '롯데마트 서울역점', address: '서울특별시 용산구 한강대로 405 서울역(철도역)', phone: '02-390-2500' },
            ...
            'blue': [
                { lat: 37.529843, lng: 126.964390, type: '본사직영:원테일', title: '원테일 용산아이파크몰점', address: '서울특별시 용산구 한강대로 23길 용산역', phone: '02-2012-1441' },
            ],
            'yellow': [
                { lat: 37.605647, lng: 127.174794, type: '기타', title: '타르틴베이커리 남양주점', address: '경기도 남양주시 다산지금로 202', phone: '031-560-9885' },
            ]
        };
