...
export const IntroduceComponent = () => {
    ...
    return (
        <div className='wrapper'>
            <div className='fromTopIn20 top'>
                <h2>플로트</h2>
            </div>
            <div className='content'>
                <div className='pb-60 fromBottomIn40'><img src={about01} alt="" /></div>
                <div className='info'>
                    <h3>
                        <span className='fromLeftIn20'>BETTER LIFE, BETTER ANSWER FOR YOUR PET</span><br/>
                        <span className='fromRightIn20'>반려동물의 더 나은 삶을 위한 더 나은 답을 찾습니다</span>
                    </h3>
                    <p>
